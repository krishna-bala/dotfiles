...
from monitor_manager.display import DisplayService
from monitor_manager.profile import ProfileService
from monitor_manager.coordinator import MonitorManagerCoordinator
from monitor_manager.reconciler import Reconciler
from monitor_manager.simulate import default_mint, simulate
from monitor_manager.state.desired import compile_desired
from monitor_manager.state.hardware import (
    BspwmDesktop,
    BspwmMonitor,
    HardwareState,
    XrandrOutput,
)
from monitor_manager.safety import SafetyService
...
class TestFullWorkflow(unittest.TestCase):
    ...
    @unittest.skipUnless(
        os.environ.get("DISPLAY") and shutil.which("xrandr"),
        "needs a live X display and xrandr (the one test here that shells out)",
    )
    ...
    def test_error_handling_invalid_profile(self):
        ...
        from monitor_manager.exceptions import ProfileNotFoundError
    ...
    def test_error_handling_missing_monitor(self):
        ...
        from monitor_manager.exceptions import ProfileValidationError
