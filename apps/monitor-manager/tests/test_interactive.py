...
from monitor_manager.interactive import InteractiveMenu, MenuChoice, run_interactive_menu
from monitor_manager.display import Monitor
from monitor_manager.profile import Profile, DisplayConfig, WindowManagerConfig, UIConfig
...
class TestInteractiveMenu(unittest.TestCase):
    ...
    @patch("monitor_manager.interactive.TerminalMenu")
    ...
    @patch("monitor_manager.interactive.TerminalMenu", None)
