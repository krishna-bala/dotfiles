...
* _Live Share Web: [joining from the browser](https://aka.ms/vsls-web) is now available for all Live Share sessions [Public Preview]_

### _Upcoming features_

* _Planned Sessions: Live Share support for sessions that can be scheduled in advance_
* _Live Share built-in chat support_
