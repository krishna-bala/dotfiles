...
set timeoutlen=400							
"" milliseconds waited for mapped sequence to complete.
...
" in insert mode
set tabstop=2								
" set the space occupied by a regular tabset autoindent
set linebreak breakindent		
" break line at 'break' character and indent to line indent
set mouse=a									
